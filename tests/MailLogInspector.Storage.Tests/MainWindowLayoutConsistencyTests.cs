...
public sealed class MainWindowLayoutConsistencyTests
{
    ...
    public void BusinessHelpVersionMatchesProjectVersion()
    {
        ...
        Assert.Contains("<InformationalVersion>0.215</InformationalVersion>", project, StringComparison.Ordinal);
        Assert.Contains("SemanticVersion = \"0.215\"", version, StringComparison.Ordinal);
    }
