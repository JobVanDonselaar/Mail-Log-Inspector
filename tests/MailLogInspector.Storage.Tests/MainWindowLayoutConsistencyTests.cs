...
public sealed class MainWindowLayoutConsistencyTests
{
    ...
    public void BusinessHelpVersionMatchesProjectVersion()
    {
        ...
        Assert.Contains("<InformationalVersion>0.242</InformationalVersion>", project, StringComparison.Ordinal);
        Assert.Contains("SemanticVersion = \"0.242\"", version, StringComparison.Ordinal);
    }
