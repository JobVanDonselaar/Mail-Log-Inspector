...
public sealed class MainWindowLayoutConsistencyTests
{
    ...
    [Fact]
    public void BusinessHelpUsesVersion0202()
    {
        string root = Path.GetFullPath(Path.Combine(AppContext.BaseDirectory, "..", "..", "..", "..", ".."));
        ...
        Assert.Contains("<InformationalVersion>0.202</InformationalVersion>", project, StringComparison.Ordinal);
        Assert.Contains("SemanticVersion = \"0.202\"", version, StringComparison.Ordinal);
    }
