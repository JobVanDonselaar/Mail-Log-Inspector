...
public sealed class MainWindowLayoutConsistencyTests
{
    ...
    public void BusinessHelpVersionMatchesProjectVersion()
    {
        ...
        Assert.Contains("<InformationalVersion>0.236</InformationalVersion>", project, StringComparison.Ordinal);
        Assert.Contains("SemanticVersion = \"0.236\"", version, StringComparison.Ordinal);
    }
