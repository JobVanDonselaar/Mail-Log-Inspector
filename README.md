...
- De extra `Excel export`-knop exporteert de top 25/50/100 van langste aflevertijden (eerste event tot afgeleverd) voor de gekozen periode, met samenvatting, volledige archiefhistorie per mail en filtercontext. De archieven worden hiervoor één keer gezamenlijk doorzocht en beperkt tot importperioden die de bekende mailperiode overlappen; archieven zonder periode-informatie blijven veilig meegenomen.
